...
{
     global $dsql;
    $dsql->sendRequest('SELECT * from ligue where id='.$i);
    $dsql->res_tab_assoc($line);
    return $line['name'];
}
function listClan($i)
{
     global $dsql;
    $dsql->sendRequest('SELECT * from clan where id='.$i);
    $dsql->res_tab_assoc($line);
    return $line['name'];
}
...
[color=white][u][b]Chronique[/b][/u] : [/color]'.$line['field_top'].'<br/>

[color=white][u][b]Faction[/b][/u] : [/color]'.$line['field_bottom'].'<br/>

[color=white][u][b]Nom du groupe[/b][/u] : [/color]'.$line['field_middle'].'<br/>

[color=white][u][b]Age[/b][/u] : [/color]'.$line['ig_age'].'<br/>

[color=white][u][b]Moralité[/b][/u] : [/color]'.$line['mmoral'].'<br/>
